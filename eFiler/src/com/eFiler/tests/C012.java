...
public class C012 extends BaseTestLogic {
	
	private static String file_name = "", filename_title = "", successMsg = "";

	
	public C012(WebDriver webDriver, File fileConf, File fileReport) {
	...
	void startTest() throws InterruptedException  {
		System.out.println("*****************************************************************");
		System.out.println("*                    Redirect to Search folder                  *");
		System.out.println("*****************************************************************");
		System.out.println("Test C012 - eFiler -> Redirect to Search folder");
		System.out.println("If you click searched folder can it redirect inside that folder?\n" +
